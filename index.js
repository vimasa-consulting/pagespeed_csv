...
async function fetchPageSpeedForDomain(domain) {
    ...
    .then(([desktop, mobile]) => {
        var response=[
            ...
            mobile.lighthouseResult.categories['best-practices']?mobile.lighthouseResult.categories['best-practices']['score']*100:0,       
            ...
            mobile.lighthouseResult.audits['cumulative-layout-shift']?mobile.lighthouseResult.audits['cumulative-layout-shift']['score'] * 100:0,      
